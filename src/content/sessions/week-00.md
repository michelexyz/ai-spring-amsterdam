...
### The reading 📄
To understand better the need for these benchmarks, which ultimately guide AI progress, I propose we read this paper Chollet wrote in 2019.  Here he provides a new perspective on the oldest problem in AI, "how do we define intelligence?", which is extended to the question "how do we measure it?".

Link to the paper: https://arxiv.org/abs/1911.01547
Read chapter I (~1h) and II.1 (~35min).
There is no math in these parts and it reads smoothly.
Feel free to read fully chapter II (it provides a more thecnical definition of intellicence) and III (introduces the ARC-AGI benchmark) if you have time and interest. 